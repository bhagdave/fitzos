...
class Athlete extends CI_Controller{
   ...
   {table_open}<table border="1" cellpadding="1" cellspacing="1">{/table_open}
...
';			
			...
			$cal =  $this->calendar->generate(null,null,$data);
		} else {
			redirect('signin/login');
			die();
		}
		$vars = array('id'=>$id,'athlete'=>$athlete,'member'=>$member,'notes'=>$notifications,'events'=>$events,'sports'=>$sports,'cal'=>$cal);
